    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-3">
                <div>
                    <Label htmlFor="serviceType" className="mb-1">{t('form_service_type')}</Label>
                    <Controller
                        name="serviceType"
                        control={control}
                ...
                <div>
                    <Label htmlFor="unitId" className="mb-1">{t('form_unit')}</Label>
                    <Controller
                        name="unitId"
                        control={control}
                ...
                <div>
                    <Label htmlFor="positionId" className="mb-1">{t('form_position')}</Label>
                    <Controller
                        name="positionId"
                        control={control}
