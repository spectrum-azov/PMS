    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-3">
                <div>
                    <Label htmlFor="callsign" className="mb-1">{t('form_callsign')}</Label>
                    <Input
                        id="callsign"
                        {...register('callsign', {
                ...
                <div>
                    <Label htmlFor="fullName" className="mb-1">{t('form_fullname')}</Label>
                    <Input
                        id="fullName"
                        {...register('fullName', {
                            required: t('common_required_field'),
                ...
                <div>
                    <Label htmlFor="rank" className="mb-1">{t('form_rank')}</Label>
                    <Controller
                        name="rank"
                        control={control}
                ...
                <div>
                    <Label htmlFor="birthDate" className="mb-1">{t('form_birthdate')}</Label>
                    <Input
                        id="birthDate"
                        type="date"
                        {...register('birthDate', {
